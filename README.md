...
To learn how Survey data in ATTAINS is linked to the dashboard, visit: [How ATTAINS data is linked Partner Dashboard](https://github.com/USEPA/Partner-Dashboard/blob/main/ATTAINS_Dashboard_setup.pdf). Once data has been published in ATTAINS, it will be displayed in the dashboard on the fly. Simply edit and republish the survey data if you would like to make a change to the dashboard.
